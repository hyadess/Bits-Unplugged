...
CREATE TABLE public."Activities" (
    ...
    "createdAt" timestamp with time zone DEFAULT '2024-02-09 01:37:03.016+06'::timestamp with time zone NOT NULL,
    "updatedAt" timestamp with time zone DEFAULT '2024-02-09 01:37:03.016+06'::timestamp with time zone NOT NULL
);
...
CREATE TABLE public."Articles" (
    ...
    "createdAt" timestamp with time zone DEFAULT '2024-02-09 01:37:03.392+06'::timestamp with time zone NOT NULL,
    "updatedAt" timestamp with time zone DEFAULT '2024-02-09 01:37:03.392+06'::timestamp with time zone NOT NULL
);
...
CREATE TABLE public."Canvases" (
    ...
    "previewOptions" json,
    template text,
    "createdAt" timestamp with time zone DEFAULT '2024-02-09 01:37:02.773+06'::timestamp with time zone NOT NULL,
    "updatedAt" timestamp with time zone DEFAULT '2024-02-09 01:37:02.773+06'::timestamp with time zone NOT NULL
);
...
CREATE TABLE public."Clarifications" (
    ...
    "createdAt" timestamp with time zone DEFAULT '2024-02-09 01:37:03.276+06'::timestamp with time zone NOT NULL,
    "updatedAt" timestamp with time zone DEFAULT '2024-02-09 01:37:03.276+06'::timestamp with time zone NOT NULL
);
...
CREATE TABLE public."ContestProblems" (
    ...
    rating integer,
    "createdAt" timestamp with time zone DEFAULT '2024-02-09 01:37:03.175+06'::timestamp with time zone NOT NULL,
    "updatedAt" timestamp with time zone DEFAULT '2024-02-09 01:37:03.175+06'::timestamp with time zone NOT NULL
);
...
CREATE TABLE public."ContestSetters" (
    ...
    "createdAt" timestamp with time zone DEFAULT '2024-02-09 01:37:03.14+06'::timestamp with time zone NOT NULL,
    "updatedAt" timestamp with time zone DEFAULT '2024-02-09 01:37:03.14+06'::timestamp with time zone NOT NULL
);
...
CREATE TABLE public."ContestSubmissions" (
    ...
    points integer,
    "createdAt" timestamp with time zone DEFAULT '2024-02-09 01:37:03.245+06'::timestamp with time zone NOT NULL,
    "updatedAt" timestamp with time zone DEFAULT '2024-02-09 01:37:03.245+06'::timestamp with time zone NOT NULL
);
...
CREATE TABLE public."Contests" (
    ...
    status character varying(255),
    "createdAt" timestamp with time zone DEFAULT '2024-02-09 01:37:03.057+06'::timestamp with time zone NOT NULL,
    "updatedAt" timestamp with time zone DEFAULT '2024-02-09 01:37:03.057+06'::timestamp with time zone NOT NULL
);
...
CREATE TABLE public."Credentials" (
    ...
    "createdAt" timestamp with time zone DEFAULT '2024-02-09 01:37:02.97+06'::timestamp with time zone NOT NULL,
    "updatedAt" timestamp with time zone DEFAULT '2024-02-09 01:37:02.97+06'::timestamp with time zone NOT NULL
);
...
CREATE TABLE public."DailyActivities" (
    ...
    "userId" integer NOT NULL,
    "problemId" integer,
    "activityDate" timestamp with time zone DEFAULT '2024-02-09 01:37:03.353+06'::timestamp with time zone NOT NULL,
    duration integer DEFAULT 0 NOT NULL,
    "createdAt" timestamp with time zone DEFAULT '2024-02-09 01:37:03.353+06'::timestamp with time zone NOT NULL,
    "updatedAt" timestamp with time zone DEFAULT '2024-02-09 01:37:03.353+06'::timestamp with time zone NOT NULL
);
...
CREATE TABLE public."EmailVerifications" (
    ...
    "createdAt" timestamp with time zone DEFAULT '2024-02-09 01:37:03.314+06'::timestamp with time zone NOT NULL,
    "updatedAt" timestamp with time zone DEFAULT '2024-02-09 01:37:03.314+06'::timestamp with time zone NOT NULL
);
...
CREATE TABLE public."Participants" (
    ...
    "userId" integer,
    type integer,
    "createdAt" timestamp with time zone DEFAULT '2024-02-09 01:37:03.211+06'::timestamp with time zone NOT NULL,
    "updatedAt" timestamp with time zone DEFAULT '2024-02-09 01:37:03.211+06'::timestamp with time zone NOT NULL
);
...
CREATE TABLE public."ProblemVersions" (
    ...
    "createdAt" timestamp with time zone DEFAULT '2024-02-09 01:37:02.918+06'::timestamp with time zone NOT NULL,
    "updatedAt" timestamp with time zone DEFAULT '2024-02-09 01:37:02.918+06'::timestamp with time zone NOT NULL
);
...
CREATE TABLE public."Problems" (
    ...
    "checkerCode" text,
    "checkerCanvas" json,
    "createdAt" timestamp with time zone DEFAULT '2024-02-09 01:37:02.873+06'::timestamp with time zone NOT NULL,
    "updatedAt" timestamp with time zone DEFAULT '2024-02-09 01:37:02.873+06'::timestamp with time zone NOT NULL
);
...
CREATE TABLE public."Series" (
    ...
    "serialNo" integer DEFAULT 0,
    "createdAt" timestamp with time zone DEFAULT '2024-02-09 01:37:02.71+06'::timestamp with time zone NOT NULL,
    "updatedAt" timestamp with time zone DEFAULT '2024-02-09 01:37:02.71+06'::timestamp with time zone NOT NULL
);
...
CREATE TABLE public."Setters" (
    ...
    "createdAt" timestamp with time zone DEFAULT '2024-02-09 01:37:02.828+06'::timestamp with time zone NOT NULL,
    "updatedAt" timestamp with time zone DEFAULT '2024-02-09 01:37:02.828+06'::timestamp with time zone NOT NULL
);
...
CREATE TABLE public."Submissions" (
    ...
    "canvasData" json,
    "createdAt" timestamp with time zone DEFAULT '2024-02-09 01:37:03.099+06'::timestamp with time zone NOT NULL,
    "updatedAt" timestamp with time zone DEFAULT '2024-02-09 01:37:03.099+06'::timestamp with time zone NOT NULL
);
...
CREATE TABLE public."Topics" (
    ...
    "isLive" boolean DEFAULT false,
    "serialNo" integer DEFAULT 0,
    "createdAt" timestamp with time zone DEFAULT '2024-02-09 01:37:02.586+06'::timestamp with time zone NOT NULL,
    "updatedAt" timestamp with time zone DEFAULT '2024-02-09 01:37:02.586+06'::timestamp with time zone NOT NULL
);
...
CREATE TABLE public."Users" (
    ...
    "createdAt" timestamp with time zone DEFAULT '2024-02-09 01:37:02.652+06'::timestamp with time zone NOT NULL,
    "updatedAt" timestamp with time zone DEFAULT '2024-02-09 01:37:02.652+06'::timestamp with time zone NOT NULL
);
...
1	2	12	0	t	2024-02-09 01:38:31.45+06	2024-02-09 01:38:31.45+06	0	4	2024-02-09 01:38:31.45+06	2024-02-09 01:38:31.478+06
\.
...
1	1	1	published	200	2024-02-09 01:37:03.175+06	2024-02-09 01:37:03.175+06
\.
...
1	1	1	owner	2024-02-09 01:37:03.14+06	2024-02-09 01:37:03.14+06
\.
...
1	Demo Contest	Demo contest description	2025-01-01 06:00:00+06	2025-01-02 06:00:00+06	upcoming	2024-02-09 01:37:07.541+06	2024-02-09 01:37:07.541+06
\.
...
1	1	mahirlabibdihan@gmail.com	$2a$10$kK3WAxrbCLl0qHjswaujb.MYnkqRUeLLO0Pck80QFhc47FLnLWKOK	1	2024-02-09 01:37:07.486+06	2024-02-09 01:37:07.486+06
2	2	mahirlabibdihan@gmail.com	$2a$10$kK3WAxrbCLl0qHjswaujb.MYnkqRUeLLO0Pck80QFhc47FLnLWKOK	0	2024-02-09 01:37:07.486+06	2024-02-09 01:37:07.486+06
3	3	sayemshahadsoummo@gmail.com	$2a$10$kK3WAxrbCLl0qHjswaujb.MYnkqRUeLLO0Pck80QFhc47FLnLWKOK	1	2024-02-09 01:37:07.486+06	2024-02-09 01:37:07.486+06
4	4	sayemshahadsoummo@gmail.com	$2a$10$kK3WAxrbCLl0qHjswaujb.MYnkqRUeLLO0Pck80QFhc47FLnLWKOK	0	2024-02-09 01:37:07.486+06	2024-02-09 01:37:07.486+06
5	5	souvik7701@gmail.com	$2a$10$kK3WAxrbCLl0qHjswaujb.MYnkqRUeLLO0Pck80QFhc47FLnLWKOK	1	2024-02-09 01:37:07.486+06	2024-02-09 01:37:07.486+06
6	6	souvik7701@gmail.com	$2a$10$kK3WAxrbCLl0qHjswaujb.MYnkqRUeLLO0Pck80QFhc47FLnLWKOK	0	2024-02-09 01:37:07.486+06	2024-02-09 01:37:07.486+06
7	7	mahirlabibdihan@gmail.com	$2a$10$yGG7Td2huTYO8YUlbRQKb.lJ6aNCYuhkMivF/yAxygtnF81MoHcTK	2	2024-02-09 01:37:07.486+06	2024-02-09 01:37:07.486+06
\.
...
COPY public."DailyActivities" (id, "userId", "problemId", "activityDate", duration, "createdAt", "updatedAt") FROM stdin;
1	2	12	2024-02-09 01:38:31.47+06	4	2024-02-09 01:38:31.47+06	2024-02-09 01:38:31.47+06
2	2	12	2024-02-09 01:39:15.351+06	48	2024-02-09 01:39:15.351+06	2024-02-09 01:39:15.351+06
\.
...
COPY public."ProblemVersions" (id, "seriesId", "problemId", "canvasId", version, title, statement, "serialNo", "isLive", "canvasData", "editOptions", "previewOptions", "checkerCode", "checkerCanvas", "approvalStatus", feedback, rating, "createdAt", "updatedAt") FROM stdin;
1	1	1	2	1	3 Disks	Move the 3 disks from left peg to right peg. You can use the middle peg to temporarily keep the disks.	4	t	{"pegs":[[0,1,2],[],[]]}	{"customDisk":{"value":true,"type":"switch"},"ordered":{"value":true,"type":"switch"}}	{"moves":{"value":false,"type":"switch"},"nDisks":{"value":false,"type":"switch"},"customDisk":{"value":false,"type":"switch"},"undo":{"value":true,"type":"switch"}}	/**\n *\n * @param {Object} data - An object containing pegs and disks.\n * @param {Array} data.pegs - Array of list of disks.\n * @returns {boolean} True if the solution is valid, otherwise false.\n */\nfunction solutionChecker(userCanvas,solutionCanvas,userActivity) {\n  return JSON.stringify(userCanvas) === JSON.stringify(solutionCanvas);\n}\n	{"pegs":[[],[],[0,1,2]]}	1	\N	800	2024-02-09 01:37:02.918+06	2024-02-09 01:37:02.918+06
2	1	1	2	2	3 Disks	Move the 3 disks from left peg to right peg. You can use the middle peg to temporarily keep the disks.	4	t	{"pegs":[[0,1,2],[],[]]}	{"customDisk":{"value":true,"type":"switch"},"ordered":{"value":true,"type":"switch"}}	{"moves":{"value":false,"type":"switch"},"nDisks":{"value":false,"type":"switch"},"customDisk":{"value":false,"type":"switch"},"undo":{"value":true,"type":"switch"}}	/**\n *\n * @param {Object} data - An object containing pegs and disks.\n * @param {Array} data.pegs - Array of list of disks.\n * @returns {boolean} True if the solution is valid, otherwise false.\n */\nfunction solutionChecker(userCanvas,solutionCanvas,userActivity) {\n  return JSON.stringify(userCanvas) === JSON.stringify(solutionCanvas);\n}\n	{"pegs":[[],[],[0,1,2]]}	0	Problem statement is ambiguous.	800	2024-02-09 01:37:02.918+06	2024-02-09 01:37:02.918+06
3	1	1	2	3	3 Disks	Move the 3 disks from left peg to right peg. You can use the middle peg to temporarily keep the disks.	4	t	{"pegs":[[0,1,2],[],[]]}	{"customDisk":{"value":true,"type":"switch"},"ordered":{"value":true,"type":"switch"}}	{"moves":{"value":false,"type":"switch"},"nDisks":{"value":false,"type":"switch"},"customDisk":{"value":false,"type":"switch"},"undo":{"value":true,"type":"switch"}}	/**\n *\n * @param {Object} data - An object containing pegs and disks.\n * @param {Array} data.pegs - Array of list of disks.\n * @returns {boolean} True if the solution is valid, otherwise false.\n */\nfunction solutionChecker(userCanvas,solutionCanvas,userActivity) {\n  return JSON.stringify(userCanvas) === JSON.stringify(solutionCanvas);\n}\n	{"pegs":[[],[],[0,1,2]]}	2	\N	800	2024-02-09 01:37:02.918+06	2024-02-09 01:37:02.918+06
...
3	1	2	Min 4 Disks	Move the 4 disks from left to right peg in minimum possible moves.	{"pegs":[[0,1,2,3],[],[]]}	{"customDisk":{"value":true,"type":"switch"},"ordered":{"value":true,"type":"switch"}}	{"moves":{"value":true,"type":"switch"},"nDisks":{"value":false,"type":"switch"},"customDisk":{"value":false,"type":"switch"},"undo":{"value":true,"type":"switch"}}	/**\n *\n * @param {Object} data - An object containing pegs and disks.\n * @param {Array} data.pegs - Array of list of disks.\n * @returns {boolean} True if the solution is valid, otherwise false.\n */\nfunction solutionChecker(userCanvas,solutionCanvas,userActivity) {\n return JSON.stringify(userCanvas) === JSON.stringify(solutionCanvas) && userActivity.numberOfMoves == 15;\n}\n	{"pegs":[[],[],[0,1,2,3]]}	2024-02-09 01:37:02.873+06	2024-02-09 01:37:02.873+06
4	1	2	Double TOH	Move the disks from left peg to right peg.	{"pegs":[[0,10,2,12,4,14,6,16,8,18],[],[]]}	{"customDisk":{"value":true,"type":"switch"},"ordered":{"value":true,"type":"switch"}}	{"moves":{"value":true,"type":"switch"},"nDisks":{"value":false,"type":"switch"},"customDisk":{"value":false,"type":"switch"},"undo":{"value":true,"type":"switch"}}	\nfunction solutionChecker(userCanvas,solutionCanvas,userActivity) {\n return JSON.stringify(userCanvas) === JSON.stringify(solutionCanvas) && userActivity.numberOfMoves == 62;\n}\n	{"pegs":[[],[],[10,0,2,12,4,14,6,16,8,18]]}	2024-02-09 01:37:02.873+06	2024-02-09 01:37:02.873+06
5	1	1	Road Construction	There are 5 cities numbered from 0 to 4. We can construct roads between cities. Each road has a number associated with it denoting the cost to construct a road. We want to minimize our cost. **Select the roads from the given canvas in a way that from every city we can go to every other city and cost of constructing the roads are minimum.**	{"edges":[{"start":"0","end":"1","weight":"10"},{"start":"3","end":"1","weight":"5"},{"start":"1","end":"2","weight":"30"},{"start":"0","end":"4","weight":"2"},{"start":"4","end":"3","weight":"3"},{"start":"4","end":"2","weight":"50"}],"nodes":{"0":{"x":159,"y":218.8000030517578,"label":0,"color":"Default"},"1":{"x":386,"y":87.80000305175781,"label":1,"color":"Default"},"2":{"x":628,"y":217.8000030517578,"label":2,"color":"Default"},"3":{"x":387,"y":234.8000030517578,"label":3,"color":"Default"},"4":{"x":392,"y":396.8000030517578,"label":4,"color":"Default"}},"selectedEdges":[],"selectedNodes":[]}	{"directedEdge":{"value":false,"type":"switch"},"weightedEdge":{"value":true,"type":"switch"}}	{"addNode":{"value":false,"type":"switch"},"deleteNode":{"value":false,"type":"switch"},"dragNode":{"value":false,"type":"switch"},"addEdge":{"value":false,"type":"switch"},"deleteEdge":{"value":false,"type":"switch"},"editWeight":{"value":false,"type":"switch"},"editColor":{"value":false,"type":"switch"}}	/**\n * @param {Object} data (userCanvas/solutionCanvas) - An object containing nodes and edges properties.\n * @param {Array} data.nodes - HashMap of nodes. Where each node is an object with x,y properties.\n * @param {Array} data.edges - Array of edges. Where each edge is an object with start, end, weight properties.\n * @param {Array} data.selectedEdges - Array of selectedEdges. Where each edge is an object with start, end, weight properties.\n * @returns {boolean} True if the solution is valid, otherwise false.\n */\nfunction solutionChecker(userCanvas, solutionCanvas) {\n  return JSON.stringify(userCanvas) === JSON.stringify(solutionCanvas);\n}\n	{"edges":[{"start":"0","end":"1","weight":"10"},{"start":"3","end":"1","weight":"5"},{"start":"1","end":"2","weight":"30"},{"start":"0","end":"4","weight":"2"},{"start":"4","end":"3","weight":"3"},{"start":"4","end":"2","weight":"50"}],"nodes":{"0":{"x":159,"y":218.8000030517578,"label":0,"color":"Default"},"1":{"x":386,"y":87.80000305175781,"label":1,"color":"Default"},"2":{"x":628,"y":217.8000030517578,"label":2,"color":"Default"},"3":{"x":387,"y":234.8000030517578,"label":3,"color":"Default"},"4":{"x":392,"y":396.8000030517578,"label":4,"color":"Default"}},"selectedEdges":[{"start":"0","end":"4","weight":"2"},{"start":"1","end":"2","weight":"30"},{"start":"3","end":"1","weight":"5"},{"start":"4","end":"3","weight":"3"}],"selectedNodes":[]}	2024-02-09 01:37:02.873+06	2024-02-09 01:37:02.873+06
6	1	1	Road Construction 2	Similar to version 1.	{"edges":[{"start":"0","end":"1","weight":"3"},{"start":"1","end":"4","weight":"3"},{"start":"4","end":"6","weight":"3"},{"start":"3","end":"6","weight":"3"},{"start":"2","end":"3","weight":"3"},{"start":"0","end":"2","weight":"3"},{"start":"5","end":"3","weight":"5"},{"start":"5","end":"2","weight":"5"},{"start":"0","end":"5","weight":"5"},{"start":"1","end":"5","weight":"5"},{"start":"5","end":"4","weight":"5"},{"start":"5","end":"6","weight":"5"}],"nodes":{"0":{"x":142,"y":196,"label":0,"color":"Default"},"1":{"x":274,"y":45,"label":1,"color":"Default"},"2":{"x":284,"y":357,"label":2,"color":"Default"},"3":{"x":492,"y":358,"label":3,"color":"Default"},"4":{"x":498,"y":41,"label":4,"color":"Default"},"5":{"x":391,"y":197,"label":5,"color":"Default"},"6":{"x":652,"y":205,"label":6,"color":"Default"}},"selectedEdges":[],"selectedNodes":[]}	{"directedEdge":{"value":false,"type":"switch"},"weightedEdge":{"value":true,"type":"switch"}}	{"addNode":{"value":false,"type":"switch"},"deleteNode":{"value":false,"type":"switch"},"dragNode":{"value":false,"type":"switch"},"addEdge":{"value":false,"type":"switch"},"deleteEdge":{"value":false,"type":"switch"},"editWeight":{"value":false,"type":"switch"},"editColor":{"value":false,"type":"switch"}}	/**\n * @param {Object} data - An object containing nodes and edges properties.\n * @param {Array} data.nodes - Array of nodes. Where each node is an object with x,y properties.\n * @param {Array} data.edges - Array of edges. Where each edge is an object with start, end properties.\n * @returns {boolean} True if the solution is valid, otherwise false.\n */\n\nfunction createGraph(edges) {\n  const graph = new Map();\n  for (const edge of edges) {\n    const { start, end, weight } = edge;\n\n    if (!graph.has(start)) {\n      graph.set(start, []);\n    }\n\n    if (!graph.has(end)) {\n      graph.set(end, []);\n    }\n\n    graph.get(start).push({ value: end, weight: parseInt(weight) });\n    graph.get(end).push({ value: start, weight: parseInt(weight) });\n  }\n  return graph;\n}\nfunction getCost(graph) {\n  // Step 3: Implement DFS to check if the graph is disconnected\n  function isDisconnected() {\n    const visited = new Set();\n    const nodes = [...graph.keys()];\n\n    function dfs(node) {\n      visited.add(node);\n      for (const neighbor of graph.get(node)) {\n        if (!visited.has(neighbor.value)) {\n          dfs(neighbor.value);\n        }\n      }\n    }\n    dfs(nodes[0]); // Start DFS from the first node\n    return visited.size !== nodes.length;\n  }\n\n  const disconnected = isDisconnected();\n\n  // Step 4: Calculate the sum of edge weights\n  function sumEdgeWeights() {\n    let sum = 0;\n    for (const edges of graph.values()) {\n      for (const edge of edges) {\n        sum += edge.weight;\n      }\n    }\n    return sum / 2;\n  }\n\n  if (disconnected) return -1;\n\n  const edgeWeightSum = sumEdgeWeights();\n  return edgeWeightSum;\n}\nfunction solutionChecker(userCanvas, solutionCanvas) {\n  const user_graph = createGraph(userCanvas.selectedEdges);\n  const setter_graph = createGraph(solutionCanvas.selectedEdges);\n\n  if (Array.from(user_graph.keys()).length !== Array.from(setter_graph.keys()).length)\n    return false;\n  const user_cost = getCost(user_graph);\n  const setter_cost = getCost(setter_graph);\n  console.log(user_cost);\n  if (user_cost !== -1 && user_cost === setter_cost) {\n    return true;\n  } else {\n    return false;\n  }\n}\n	{"edges":[{"start":"0","end":"1","weight":"3"},{"start":"1","end":"4","weight":"3"},{"start":"4","end":"6","weight":"3"},{"start":"3","end":"6","weight":"3"},{"start":"2","end":"3","weight":"3"},{"start":"0","end":"2","weight":"3"},{"start":"5","end":"3","weight":"5"},{"start":"5","end":"2","weight":"5"},{"start":"0","end":"5","weight":"5"},{"start":"1","end":"5","weight":"5"},{"start":"5","end":"4","weight":"5"},{"start":"5","end":"6","weight":"5"}],"nodes":{"0":{"x":142,"y":196,"label":0,"color":"Default"},"1":{"x":274,"y":45,"label":1,"color":"Default"},"2":{"x":284,"y":357,"label":2,"color":"Default"},"3":{"x":492,"y":358,"label":3,"color":"Default"},"4":{"x":498,"y":41,"label":4,"color":"Default"},"5":{"x":391,"y":197,"label":5,"color":"Default"},"6":{"x":652,"y":205,"label":6,"color":"Default"}},"selectedEdges":[{"start":"0","end":"1","weight":"3"},{"start":"0","end":"2","weight":"3"},{"start":"1","end":"4","weight":"3"},{"start":"2","end":"3","weight":"3"},{"start":"3","end":"6","weight":"3"},{"start":"4","end":"6","weight":"3"},{"start":"5","end":"2","weight":"5"}],"selectedNodes":[]}	2024-02-09 01:37:02.873+06	2024-02-09 01:37:02.873+06
7	1	1	Coloring	Draw the graph with only 3 colors. **No nodes should be left to default color.**	{"edges":[{"start":"8","end":"6","weight":"0"},{"start":"6","end":"9","weight":"0"},{"start":"9","end":"5","weight":"0"},{"start":"5","end":"7","weight":"0"},{"start":"7","end":"8","weight":"0"},{"start":"8","end":"3","weight":"0"},{"start":"9","end":"4","weight":"0"},{"start":"7","end":"2","weight":"0"},{"start":"1","end":"6","weight":"0"},{"start":"0","end":"5","weight":"0"},{"start":"0","end":"3","weight":"0"},{"start":"4","end":"2","weight":"0"},{"start":"4","end":"3","weight":"0"},{"start":"0","end":"1","weight":"0"},{"start":"1","end":"2","weight":"0"}],"nodes":{"0":{"x":198.79998779296875,"y":232,"label":"","color":"Default"},"1":{"x":444.79998779296875,"y":39,"label":"","color":"Default"},"2":{"x":683.7999877929688,"y":233,"label":"","color":"Default"},"3":{"x":310.79998779296875,"y":431,"label":"","color":"Default"},"4":{"x":590.7999877929688,"y":428,"label":"","color":"Default"},"5":{"x":311.79998779296875,"y":235,"label":"","color":"Default"},"6":{"x":446.79998779296875,"y":142,"label":"","color":"Default"},"7":{"x":579.7999877929688,"y":235,"label":"","color":"Default"},"8":{"x":362.79998779296875,"y":344,"label":"","color":"Default"},"9":{"x":539.7999877929688,"y":345,"label":"","color":"Default"}},"selectedEdges":[],"selectedNodes":[]}	{"directedEdge":{"value":false,"type":"switch"},"weightedEdge":{"value":false,"type":"switch"}}	{"addNode":{"value":false,"type":"switch"},"deleteNode":{"value":false,"type":"switch"},"dragNode":{"value":true,"type":"switch"},"addEdge":{"value":false,"type":"switch"},"deleteEdge":{"value":false,"type":"switch"},"editWeight":{"value":false,"type":"switch"},"editColor":{"value":true,"type":"switch"}}	/**\r\n *\r\n * @param {Object} data - An object containing nodes and edges properties.\r\n * @param {Array} data.nodes - Array of nodes. Where each node is an object with x,y properties.\r\n * @param {Array} data.edges - Array of edges. Where each edge is an object with start, end properties.\r\n * @returns {boolean} True if the solution is valid, otherwise false.\r\n */\r\nfunction solutionChecker(data) {\r\n  // const edges =  data.edges.map(edge => ({\r\n\t// \tstart: edge.start,\r\n\t// \tend: edge.end,\r\n\t// \tweight: edge.weight\r\n  // }));\r\n  \r\n\r\n  const allEdgesHaveDifferentColors = data.edges.every(\r\n    edge => data.nodes[edge.start].color !== data.nodes[edge.end].color && data.nodes[edge.end].color !== "Default"); \r\n\r\n  const uniqueColorsSet = new Set();\r\n  data.edges.forEach(edge => {\r\n    uniqueColorsSet.add(data.nodes[edge.start].color);\r\n    uniqueColorsSet.add(data.nodes[edge.end].color);\r\n  });\r\n\r\n  const numberOfUniqueColors = uniqueColorsSet.size;\r\n\r\n  return allEdgesHaveDifferentColors && numberOfUniqueColors == 3;\r\n}	\N	2024-02-09 01:37:02.873+06	2024-02-09 01:37:02.873+06
...
13	1	1	Dijkstra	Find shortest path from A to F.	{"edges":[{"start":"0","end":"1","weight":"4"},{"start":"0","end":"2","weight":"2"},{"start":"2","end":"4","weight":"3"},{"start":"1","end":"2","weight":"5"},{"start":"1","end":"3","weight":"10"},{"start":"4","end":"3","weight":"4"},{"start":"3","end":"5","weight":"11"}],"nodes":{"0":{"x":166.79998779296875,"y":198.4666748046875,"label":"A","color":"Default"},"1":{"x":326.79998779296875,"y":71.4666748046875,"label":"B","color":"Default"},"2":{"x":316.79998779296875,"y":284.4666748046875,"label":"C","color":"Default"},"3":{"x":493.79998779296875,"y":75.4666748046875,"label":"D","color":"Default"},"4":{"x":521.7999877929688,"y":275.4666748046875,"label":"E","color":"Default"},"5":{"x":700.7999877929688,"y":168.4666748046875,"label":"F","color":"Default"}},"selectedEdges":[],"selectedNodes":[]}	{"directedEdge":{"value":true,"type":"switch"},"weightedEdge":{"value":true,"type":"switch"}}	{"addNode":{"value":false,"type":"switch"},"deleteNode":{"value":false,"type":"switch"},"dragNode":{"value":false,"type":"switch"},"addEdge":{"value":false,"type":"switch"},"deleteEdge":{"value":false,"type":"switch"},"editWeight":{"value":false,"type":"switch"},"editColor":{"value":false,"type":"switch"}}	/**\n *\n * @param {Object} data - An object containing nodes and edges properties.\n * @param {Array} data.nodes - Array of nodes. Where each node is an object with x,y properties.\n * @param {Array} data.edges - Array of edges. Where each edge is an object with start, end properties.\n * @returns {boolean} True if the solution is valid, otherwise false.\n */\nfunction solutionChecker(userCanvas,solutionCanvas,userActivity) {\n  return JSON.stringify(userCanvas) === JSON.stringify(solutionCanvas);\n}\n	{"edges":[{"start":"0","end":"1","weight":"4"},{"start":"0","end":"2","weight":"2"},{"start":"2","end":"4","weight":"3"},{"start":"1","end":"2","weight":"5"},{"start":"1","end":"3","weight":"10"},{"start":"4","end":"3","weight":"4"},{"start":"3","end":"5","weight":"11"}],"nodes":{"0":{"x":166.79998779296875,"y":198.4666748046875,"label":"A","color":"Default"},"1":{"x":326.79998779296875,"y":71.4666748046875,"label":"B","color":"Default"},"2":{"x":316.79998779296875,"y":284.4666748046875,"label":"C","color":"Default"},"3":{"x":493.79998779296875,"y":75.4666748046875,"label":"D","color":"Default"},"4":{"x":521.7999877929688,"y":275.4666748046875,"label":"E","color":"Default"},"5":{"x":700.7999877929688,"y":168.4666748046875,"label":"F","color":"Default"}},"selectedEdges":[{"start":"0","end":"2","weight":"2"},{"start":"2","end":"4","weight":"3"},{"start":"3","end":"5","weight":"11"},{"start":"4","end":"3","weight":"4"}],"selectedNodes":[]}	2024-02-09 01:37:02.873+06	2024-02-09 01:37:02.873+06
14	1	1	Wandering Merchant Dilemma	Given a connected graph representing a network of cities and the roads connecting them, your mission is to unravel the optimal cycle for a traveling salesman. The challenge is to identify a closed loop that traverses each city exactly once, allowing the salesman to showcase their merchandise in a cyclic journey. Develop a program to discover the Graphical Sales Circuit in the given graph, providing the sequence of cities that forms the most efficient cycle, ensuring maximum coverage and minimal travel distance.	{"edges":[{"start":"1","end":"0","weight":"10"},{"start":"0","end":"2","weight":"15"},{"start":"1","end":"2","weight":"35"},{"start":"0","end":"3","weight":"20"},{"start":"3","end":"2","weight":"30"},{"start":"1","end":"3","weight":"25"}],"nodes":{"0":{"x":409.16668701171875,"y":67.06666564941406,"label":0,"color":"Default"},"1":{"x":214.16668701171875,"y":328.06666564941406,"label":1,"color":"Default"},"2":{"x":646.1666870117188,"y":368.0500030517578,"label":2,"color":"Default"},"3":{"x":414.16668701171875,"y":236.86666870117188,"label":3,"color":"Default"}},"selectedEdges":[],"selectedNodes":[]}	{"directedEdge":{"value":false,"type":"switch"},"weightedEdge":{"value":true,"type":"switch"}}	{"addNode":{"value":false,"type":"switch"},"deleteNode":{"value":false,"type":"switch"},"dragNode":{"value":false,"type":"switch"},"addEdge":{"value":false,"type":"switch"},"deleteEdge":{"value":false,"type":"switch"},"editWeight":{"value":false,"type":"switch"},"editColor":{"value":false,"type":"switch"}}	/**\n *\n * @param {Object} data - An object containing nodes and edges properties.\n * @param {Array} data.nodes - Array of nodes. Where each node is an object with x,y properties.\n * @param {Array} data.edges - Array of edges. Where each edge is an object with start, end properties.\n * @returns {boolean} True if the solution is valid, otherwise false.\n */\nfunction solutionChecker(userCanvas,solutionCanvas,userActivity) {\n  return JSON.stringify(userCanvas) === JSON.stringify(solutionCanvas);\n}\n	{"edges":[{"start":"1","end":"0","weight":"10"},{"start":"0","end":"2","weight":"15"},{"start":"1","end":"2","weight":"35"},{"start":"0","end":"3","weight":"20"},{"start":"3","end":"2","weight":"30"},{"start":"1","end":"3","weight":"25"}],"nodes":{"0":{"x":409.16668701171875,"y":67.06666564941406,"label":0,"color":"Default"},"1":{"x":214.16668701171875,"y":328.06666564941406,"label":1,"color":"Default"},"2":{"x":646.1666870117188,"y":368.0500030517578,"label":2,"color":"Default"},"3":{"x":414.16668701171875,"y":236.86666870117188,"label":3,"color":"Default"}},"selectedEdges":[{"start":"0","end":"2","weight":"15"},{"start":"1","end":"0","weight":"10"},{"start":"1","end":"3","weight":"25"},{"start":"3","end":"2","weight":"30"}],"selectedNodes":[]}	2024-02-09 01:37:02.873+06	2024-02-09 01:37:02.873+06
15	1	1	Red Black	Delete 5.	{"edges":[{"start":"1","end":"3","weight":"0"},{"start":"1","end":"4","weight":"0"},{"start":"1","end":"0","weight":"0"},{"start":"0","end":"2","weight":"0"},{"start":"2","end":"5","weight":"0"},{"start":"2","end":"6","weight":"0"}],"nodes":{"0":{"x":451.16668701171875,"y":54.46665954589844,"label":0,"color":"Black"},"1":{"x":327.16668701171875,"y":183.46665954589844,"label":1,"color":"Red"},"2":{"x":561.1666870117188,"y":183.46665954589844,"label":2,"color":"Red"},"3":{"x":159.16668701171875,"y":235.46665954589844,"label":3,"color":"Black"},"4":{"x":366.16668701171875,"y":337.46665954589844,"label":4,"color":"Black"},"5":{"x":533.1666870117188,"y":336.46665954589844,"label":5,"color":"Black"},"6":{"x":739.1666870117188,"y":234.46665954589844,"label":6,"color":"Black"}},"selectedEdges":[],"selectedNodes":[]}	{"directedEdge":{"value":false,"type":"switch"},"weightedEdge":{"value":false,"type":"switch"}}	{"addNode":{"value":false,"type":"switch"},"deleteNode":{"value":false,"type":"switch"},"dragNode":{"value":true,"type":"switch"},"addEdge":{"value":false,"type":"switch"},"deleteEdge":{"value":true,"type":"switch"},"editWeight":{"value":false,"type":"switch"},"editColor":{"value":false,"type":"switch"}}	/**\n *\n * @param {Object} data - An object containing nodes and edges properties.\n * @param {Array} data.nodes - Array of nodes. Where each node is an object with x,y properties.\n * @param {Array} data.edges - Array of edges. Where each edge is an object with start, end properties.\n * @returns {boolean} True if the solution is valid, otherwise false.\n */\nfunction solutionChecker(userCanvas,solutionCanvas,userActivity) {\n  return JSON.stringify(userCanvas) === JSON.stringify(solutionCanvas);\n}\n	{"edges":[],"nodes":{},"selectedEdges":[],"selectedNodes":[]}	2024-02-09 01:37:02.873+06	2024-02-09 01:37:02.873+06
16	1	1	Police Check Posts	The government plans to establish police check post with sophisticated equipment in road crossings of a city in such a way that every road has a check post. In a graph model of the city, where each vertex represents a road crossings and each edge represents a road, a vertex cover gives a feasible solution for the locations of police check posts. If the government wishes to minimize the number of police check posts for budget constraint, a vertex cover having the minimum number of vertices gives a feasible solution. A vertex cover of a graph G is a minimum vertex cover if it contains the minimum number of vertices among all vertex covers of G. **In the given graph model of the city, select the minimum number of checkposts to cover the whole city.**	{"edges":[{"start":"0","end":"1","weight":"0"},{"start":"1","end":"3","weight":"0"},{"start":"0","end":"3","weight":"0"},{"start":"1","end":"2","weight":"0"},{"start":"3","end":"2","weight":"0"},{"start":"2","end":"4","weight":"0"},{"start":"4","end":"6","weight":"0"},{"start":"4","end":"5","weight":"0"},{"start":"5","end":"6","weight":"0"},{"start":"5","end":"7","weight":"0"},{"start":"7","end":"8","weight":"0"},{"start":"7","end":"6","weight":"0"},{"start":"8","end":"6","weight":"0"}],"nodes":{"0":{"x":104.79998779296875,"y":230,"label":"a","color":"Default"},"1":{"x":193.79998779296875,"y":110,"label":"b","color":"Default"},"2":{"x":386.79998779296875,"y":180,"label":"c","color":"Default"},"3":{"x":261.79998779296875,"y":301,"label":"d","color":"Default"},"4":{"x":552.7999877929688,"y":118.19999694824219,"label":"e","color":"Default"},"5":{"x":514.7999877929688,"y":266.1999969482422,"label":"g","color":"Default"},"6":{"x":762.7999877929688,"y":138.1999969482422,"label":"f","color":"Default"},"7":{"x":663.7999877929688,"y":334.1999969482422,"label":"h","color":"Default"},"8":{"x":809.7999877929688,"y":285.1999969482422,"label":"i","color":"Default"}},"selectedEdges":[],"selectedNodes":[]}	{"directedEdge":{"value":false,"type":"switch"},"weightedEdge":{"value":false,"type":"switch"}}	{"addNode":{"value":false,"type":"switch"},"deleteNode":{"value":false,"type":"switch"},"dragNode":{"value":false,"type":"switch"},"addEdge":{"value":false,"type":"switch"},"deleteEdge":{"value":false,"type":"switch"},"editWeight":{"value":false,"type":"switch"},"editColor":{"value":false,"type":"switch"}}	/**\n *\n * @param {Object} data - An object containing nodes and edges properties.\n * @param {Array} data.nodes - Array of nodes. Where each node is an object with x,y properties.\n * @param {Array} data.edges - Array of edges. Where each edge is an object with start, end properties.\n * @returns {boolean} True if the solution is valid, otherwise false.\n */\n\nfunction isVertexCover(edges, selectedNodes) {\n  // Convert selectedNodes to a Set for faster lookup\n  const selectedNodesSet = new Set(selectedNodes);\n\n  // Iterate over all edges in the graph\n  for (let edge of edges) {\n    // Check if neither vertex of the edge is in selectedNodes\n    if (!selectedNodesSet.has(edge.start) && !selectedNodesSet.has(edge.end)) {\n      // If neither vertex is in selectedNodes, then selectedNodes is not a vertex cover\n      return false;\n    }\n  }\n\n  // If we've checked all edges and haven't returned false, then selectedNodes is a vertex cover\n  return true;\n}\n\nfunction solutionChecker(userCanvas, solutionCanvas, userActivity) {\n  if (solutionCanvas.selectedNodes.length === userCanvas.selectedNodes.length)\n  {\n    return isVertexCover(userCanvas.edges, userCanvas.selectedNodes);\n  }\n  return false;\n}\n	{"edges":[{"start":"0","end":"1","weight":"0"},{"start":"1","end":"3","weight":"0"},{"start":"0","end":"3","weight":"0"},{"start":"1","end":"2","weight":"0"},{"start":"3","end":"2","weight":"0"},{"start":"2","end":"4","weight":"0"},{"start":"4","end":"6","weight":"0"},{"start":"4","end":"5","weight":"0"},{"start":"5","end":"6","weight":"0"},{"start":"5","end":"7","weight":"0"},{"start":"7","end":"8","weight":"0"},{"start":"7","end":"6","weight":"0"},{"start":"8","end":"6","weight":"0"}],"nodes":{"0":{"x":104.79998779296875,"y":230,"label":"a","color":"Default"},"1":{"x":193.79998779296875,"y":110,"label":"b","color":"Default"},"2":{"x":386.79998779296875,"y":180,"label":"c","color":"Default"},"3":{"x":261.79998779296875,"y":301,"label":"d","color":"Default"},"4":{"x":552.7999877929688,"y":118.19999694824219,"label":"e","color":"Default"},"5":{"x":514.7999877929688,"y":266.1999969482422,"label":"g","color":"Default"},"6":{"x":762.7999877929688,"y":138.1999969482422,"label":"f","color":"Default"},"7":{"x":663.7999877929688,"y":334.1999969482422,"label":"h","color":"Default"},"8":{"x":809.7999877929688,"y":285.1999969482422,"label":"i","color":"Default"}},"selectedEdges":[],"selectedNodes":["1","3","4","6","7"]}	2024-02-09 01:37:02.873+06	2024-02-09 01:37:02.873+06
17	1	1	Independent Set	Find the maximum independent set of the given graph.	{"edges":[{"start":"0","end":"1","weight":"0"},{"start":"0","end":"3","weight":"0"},{"start":"0","end":"2","weight":"0"},{"start":"1","end":"4","weight":"0"},{"start":"4","end":"5","weight":"0"},{"start":"5","end":"6","weight":"0"},{"start":"3","end":"6","weight":"0"},{"start":"2","end":"4","weight":"0"},{"start":"2","end":"6","weight":"0"},{"start":"6","end":"7","weight":"0"},{"start":"4","end":"7","weight":"0"}],"nodes":{"0":{"x":100.79998779296875,"y":220.39999389648438,"label":0,"color":"Default"},"1":{"x":279.79998779296875,"y":84.39999389648438,"label":1,"color":"Default"},"2":{"x":338.79998779296875,"y":246.39999389648438,"label":2,"color":"Default"},"3":{"x":280.79998779296875,"y":368.3999938964844,"label":3,"color":"Default"},"4":{"x":546.7999877929688,"y":78.39999389648438,"label":4,"color":"Default"},"5":{"x":510.79998779296875,"y":212.39999389648438,"label":5,"color":"Default"},"6":{"x":665.7999877929688,"y":368.3999938964844,"label":6,"color":"Default"},"7":{"x":762.7999877929688,"y":177.39999389648438,"label":7,"color":"Default"}},"selectedEdges":[],"selectedNodes":[]}	{"directedEdge":{"value":false,"type":"switch"},"weightedEdge":{"value":false,"type":"switch"}}	{"addNode":{"value":false,"type":"switch"},"deleteNode":{"value":false,"type":"switch"},"dragNode":{"value":false,"type":"switch"},"addEdge":{"value":false,"type":"switch"},"deleteEdge":{"value":false,"type":"switch"},"editWeight":{"value":false,"type":"switch"},"editColor":{"value":false,"type":"switch"}}	/**\n *\n * @param {Object} data - An object containing nodes and edges properties.\n * @param {Array} data.nodes - Array of nodes. Where each node is an object with x,y properties.\n * @param {Array} data.edges - Array of edges. Where each edge is an object with start, end properties.\n * @returns {boolean} True if the solution is valid, otherwise false.\n */\n\nfunction isIndependentSet(edges, selectedNodes) {\n  // Convert selectedNodes to a Set for faster lookup\n  const selectedNodesSet = new Set(selectedNodes);\n\n  // Iterate over all edges in the graph\n  for (let edge of edges) {\n    // Check if both vertices of the edge are in selectedNodes\n    if (selectedNodesSet.has(edge.start) && selectedNodesSet.has(edge.end)) {\n      // If both vertices are in selectedNodes, then selectedNodes is not an independent set\n      return false;\n    }\n  }\n\n  // If we've checked all edges and haven't returned false, then selectedNodes is a vertex cover\n  return true;\n}\n\nfunction solutionChecker(userCanvas, solutionCanvas, userActivity) {\n  if (userCanvas.selectedNodes.length === solutionCanvas.selectedNodes.length) {\n    return isIndependentSet(userCanvas.edges, userCanvas.selectedNodes);\n  }\n  return false;\n}\n	{"edges":[{"start":"0","end":"1","weight":"0"},{"start":"0","end":"3","weight":"0"},{"start":"0","end":"2","weight":"0"},{"start":"1","end":"4","weight":"0"},{"start":"4","end":"5","weight":"0"},{"start":"5","end":"6","weight":"0"},{"start":"3","end":"6","weight":"0"},{"start":"2","end":"4","weight":"0"},{"start":"2","end":"6","weight":"0"},{"start":"6","end":"7","weight":"0"},{"start":"4","end":"7","weight":"0"}],"nodes":{"0":{"x":100.79998779296875,"y":220.39999389648438,"label":0,"color":"Default"},"1":{"x":279.79998779296875,"y":84.39999389648438,"label":1,"color":"Default"},"2":{"x":338.79998779296875,"y":246.39999389648438,"label":2,"color":"Default"},"3":{"x":280.79998779296875,"y":368.3999938964844,"label":3,"color":"Default"},"4":{"x":546.7999877929688,"y":78.39999389648438,"label":4,"color":"Default"},"5":{"x":510.79998779296875,"y":212.39999389648438,"label":5,"color":"Default"},"6":{"x":665.7999877929688,"y":368.3999938964844,"label":6,"color":"Default"},"7":{"x":762.7999877929688,"y":177.39999389648438,"label":7,"color":"Default"}},"selectedEdges":[],"selectedNodes":["1","2","3","5","7"]}	2024-02-09 01:37:02.873+06	2024-02-09 01:37:02.873+06
18	1	1	Fire Stations	The government plans to establish fire stations in a new city in such a way that a locality or one of its neighbor localities will have a fire station. In a graph model of the city, where each vertex represents a locality and each edge represents the neighborhood of two localities, a dominating set gives a feasible solution for the locations of fire stations. If the government wishes to minimize the number of fire stations for budget constraint, a minimum dominating set gives a feasible solution. Find the minimum dominating set of the given graph.	{"edges":[{"start":"0","end":"1","weight":"0"},{"start":"1","end":"3","weight":"0"},{"start":"0","end":"3","weight":"0"},{"start":"1","end":"2","weight":"0"},{"start":"3","end":"2","weight":"0"},{"start":"2","end":"4","weight":"0"},{"start":"4","end":"6","weight":"0"},{"start":"4","end":"5","weight":"0"},{"start":"5","end":"6","weight":"0"},{"start":"5","end":"7","weight":"0"},{"start":"7","end":"8","weight":"0"},{"start":"7","end":"6","weight":"0"},{"start":"8","end":"6","weight":"0"}],"nodes":{"0":{"x":104.79998779296875,"y":230,"label":"a","color":"Default"},"1":{"x":193.79998779296875,"y":110,"label":"b","color":"Default"},"2":{"x":386.79998779296875,"y":180,"label":"c","color":"Default"},"3":{"x":261.79998779296875,"y":301,"label":"d","color":"Default"},"4":{"x":552.7999877929688,"y":118.19999694824219,"label":"e","color":"Default"},"5":{"x":514.7999877929688,"y":266.1999969482422,"label":"g","color":"Default"},"6":{"x":762.7999877929688,"y":138.1999969482422,"label":"f","color":"Default"},"7":{"x":663.7999877929688,"y":334.1999969482422,"label":"h","color":"Default"},"8":{"x":809.7999877929688,"y":285.1999969482422,"label":"i","color":"Default"}},"selectedEdges":[],"selectedNodes":[]}	{"directedEdge":{"value":false,"type":"switch"},"weightedEdge":{"value":false,"type":"switch"}}	{"addNode":{"value":false,"type":"switch"},"deleteNode":{"value":false,"type":"switch"},"dragNode":{"value":false,"type":"switch"},"addEdge":{"value":false,"type":"switch"},"deleteEdge":{"value":false,"type":"switch"},"editWeight":{"value":false,"type":"switch"},"editColor":{"value":false,"type":"switch"}}	/**\n *\n * @param {Object} data - An object containing nodes and edges properties.\n * @param {Array} data.nodes - Array of nodes. Where each node is an object with x,y properties.\n * @param {Array} data.edges - Array of edges. Where each edge is an object with start, end properties.\n * @returns {boolean} True if the solution is valid, otherwise false.\n */\n\nfunction createGraph(edges) {\n  const graph = new Map();\n  for (const edge of edges) {\n    const { start, end, weight } = edge;\n\n    if (!graph.has(start)) {\n      graph.set(start, []);\n    }\n\n    if (!graph.has(end)) {\n      graph.set(end, []);\n    }\n\n    graph.get(start).push({ value: end, weight: parseInt(weight) });\n    graph.get(end).push({ value: start, weight: parseInt(weight) });\n  }\n  return graph;\n}\n\nfunction isDominatingSet(graph, selectedNodes) {\n    // Convert selectedNodes to a Set for faster lookup\n  const selectedNodesSet = new Set(selectedNodes);\n\n  // Create a set to store the dominated nodes\n  const dominatedNodes = new Set(selectedNodes);\n\n  // Iterate over all nodes in the graph\n  for (let node of graph.keys()) {\n    // If the node is in selectedNodes, it's already dominated\n    if (selectedNodesSet.has(node)) continue;\n\n    // Check if the node is adjacent to a node in selectedNodes\n    for (let adjacentNode of graph.get(node)) {\n      if (selectedNodesSet.has(adjacentNode.value)) {\n        dominatedNodes.add(node);\n        break;\n      }\n    }\n  }\n\n  // If the number of dominated nodes is equal to the number of nodes in the graph,\n  // then selectedNodes is a dominating set\n  return dominatedNodes.size === graph.size;\n}\n\nfunction solutionChecker(userCanvas, solutionCanvas, userActivity) {\n  if (solutionCanvas.selectedNodes.length === userCanvas.selectedNodes.length)\n  {\n    return isDominatingSet(createGraph(userCanvas.edges), userCanvas.selectedNodes);\n  }\n  return false;\n}\n	{"edges":[{"start":"0","end":"1","weight":"0"},{"start":"1","end":"3","weight":"0"},{"start":"0","end":"3","weight":"0"},{"start":"1","end":"2","weight":"0"},{"start":"3","end":"2","weight":"0"},{"start":"2","end":"4","weight":"0"},{"start":"4","end":"6","weight":"0"},{"start":"4","end":"5","weight":"0"},{"start":"5","end":"6","weight":"0"},{"start":"5","end":"7","weight":"0"},{"start":"7","end":"8","weight":"0"},{"start":"7","end":"6","weight":"0"},{"start":"8","end":"6","weight":"0"}],"nodes":{"0":{"x":104.79998779296875,"y":230,"label":"a","color":"Default"},"1":{"x":193.79998779296875,"y":110,"label":"b","color":"Default"},"2":{"x":386.79998779296875,"y":180,"label":"c","color":"Default"},"3":{"x":261.79998779296875,"y":301,"label":"d","color":"Default"},"4":{"x":552.7999877929688,"y":118.19999694824219,"label":"e","color":"Default"},"5":{"x":514.7999877929688,"y":266.1999969482422,"label":"g","color":"Default"},"6":{"x":762.7999877929688,"y":138.1999969482422,"label":"f","color":"Default"},"7":{"x":663.7999877929688,"y":334.1999969482422,"label":"h","color":"Default"},"8":{"x":809.7999877929688,"y":285.1999969482422,"label":"i","color":"Default"}},"selectedEdges":[],"selectedNodes":["1","6"]}	2024-02-09 01:37:02.873+06	2024-02-09 01:37:02.873+06
\.
...
20240205193839-create-article.js
\.
...
1	2	Tower Of Hanoi	Classic puzzle that challenges players to move a stack of disks from one peg to another, following strict rules, in the fewest possible moves.	https://us.123rf.com/450wm/ylivdesign/ylivdesign1701/ylivdesign170109038/70429747-colorful-pyramid-toy-icon-cartoon-illustration-of-colorful-pyramid-toy-vector-icon-for-web.jpg?ver=6	t	0	2024-02-09 01:37:07.464+06	2024-02-09 01:37:07.464+06
2	4	Spanning Tree		https://blog-c7ff.kxcdn.com/blog/wp-content/uploads/2017/01/blog-10.jpg	t	0	2024-02-09 01:37:07.464+06	2024-02-09 01:37:07.464+06
3	1	Shortest Path	Finding the most efficient route or path between two points in a given network or graph.	https://media.istockphoto.com/id/1204141542/vector/easy-straight-complicated-paths.jpg?s=612x612&w=0&k=20&c=93R6hIIAEw2rTicfqNuj2GLfwPdDSLNruVrgx_O_DYA=	t	0	2024-02-09 01:37:07.464+06	2024-02-09 01:37:07.464+06
4	1	Graph Coloring		https://static.vecteezy.com/system/resources/previews/029/583/668/original/color-icon-for-node-vector.jpg	t	0	2024-02-09 01:37:07.464+06	2024-02-09 01:37:07.464+06
5	1	Isomorphism		https://images-wixmp-ed30a86b8c4ca887773594c2.wixmp.com/f/d1df5349-0b0f-4d07-a13d-c59daaae9f90/dg53ht0-d224bd39-3578-42c6-acd9-0336c3f641da.jpg/v1/fill/w_904,h_884,q_70,strp/spiderman_meme_by_yostverseeditsmarvel_dg53ht0-pre.jpg?token=eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9..cv9Q8FgnY5Doy3JMOQaw6tkNp2wZ75eC1KiMELUhYas	t	0	2024-02-09 01:37:07.464+06	2024-02-09 01:37:07.464+06
6	1	Travelling Salesman		https://media.istockphoto.com/id/1227007210/vector/business-decision-modern-businessman-standing-in-front-of-signpost-showing-different.jpg?s=612x612&w=0&k=20&c=0joKPEsJLRtPPC6WTnsZZg2MCmHPD-K6wj2c1hcp1VA=	t	0	2024-02-09 01:37:07.464+06	2024-02-09 01:37:07.464+06
7	1	Planar Graph		https://miro.medium.com/v2/resize:fit:1400/1*Xo-W6UucD0e2gmOB5wescg.gif	t	0	2024-02-09 01:37:07.464+06	2024-02-09 01:37:07.464+06
8	1	Bipartite Graph		https://miro.medium.com/v2/resize:fit:588/0*PWKRBToddj9I36q4.gif	f	0	2024-02-09 01:37:07.464+06	2024-02-09 01:37:07.464+06
9	4	Red Black		https://thumbs.dreamstime.com/b/illustration-black-tree-red-apples-vector-55899640.jpg	t	0	2024-02-09 01:37:07.464+06	2024-02-09 01:37:07.464+06
10	1	BFS		https://miro.medium.com/v2/resize:fit:4800/format:webp/1*fYKrGW0IUeoS_8XtCoNaLw.gif	f	0	2024-02-09 01:37:07.464+06	2024-02-09 01:37:07.464+06
11	1	Max Flow Min Cut		https://uploads.toptal.io/blog/image/124061/toptal-blog-image-1503922944233-918c6faefd88554e45442287ce635def.gif	f	0	2024-02-09 01:37:07.464+06	2024-02-09 01:37:07.464+06
12	3	Bubble Sort		https://res.cloudinary.com/practicaldev/image/fetch/s--tZV8xTN4--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_66%2Cw_880/https://i.imgur.com/p36pPuu.gif	t	0	2024-02-09 01:37:07.464+06	2024-02-09 01:37:07.464+06
13	3	Selection Sort		https://res.cloudinary.com/practicaldev/image/fetch/s--6bITq5rX--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_66%2Cw_800/https://i0.wp.com/algorithms.tutorialhorizon.com/files/2019/01/Selection-Sort-Gif.gif%3Fzoom%3D1.25%26fit%3D300%252C214%26ssl%3D1	t	0	2024-02-09 01:37:07.464+06	2024-02-09 01:37:07.464+06
14	3	Quick Sort		https://assets.digitalocean.com/articles/alligator/js/quick-sort/quick-sort-animation.gif	t	0	2024-02-09 01:37:07.464+06	2024-02-09 01:37:07.464+06
15	3	Merge Sort		https://assets.digitalocean.com/articles/alligator/js/understanding-merge-sort/merge-sort-animation.gif	t	0	2024-02-09 01:37:07.464+06	2024-02-09 01:37:07.464+06
16	2	N Queen		https://meetwithbudhi.files.wordpress.com/2019/09/prog.gif	t	0	2024-02-09 01:37:07.464+06	2024-02-09 01:37:07.464+06
\.
...
1	1	t	2024-02-09 01:37:02.828+06	2024-02-09 01:37:02.828+06
2	3	t	2024-02-09 01:37:02.828+06	2024-02-09 01:37:02.828+06
3	5	f	2024-02-09 01:37:02.828+06	2024-02-09 01:37:02.828+06
4	8	f	2024-02-09 01:37:02.828+06	2024-02-09 01:37:02.828+06
5	9	f	2024-02-09 01:37:02.828+06	2024-02-09 01:37:02.828+06
\.
...
1	12	2	Wrong answer	{"edges":[{"start":"0","end":"1","weight":"4"},{"start":"0","end":"2","weight":"1"},{"start":"2","end":"3","weight":"2"},{"start":"3","end":"4","weight":"4"},{"start":"4","end":"6","weight":"2"},{"start":"3","end":"1","weight":"3"},{"start":"1","end":"4","weight":"4"},{"start":"6","end":"5","weight":"8"},{"start":"2","end":"5","weight":"6"}],"nodes":{"0":{"x":125.60000610351562,"y":202.26666259765625,"label":0,"color":"Default"},"1":{"x":298.6000061035156,"y":71.26666259765625,"label":1,"color":"Default"},"2":{"x":271.6000061035156,"y":376.26666259765625,"label":2,"color":"Default"},"3":{"x":435.6000061035156,"y":236.26666259765625,"label":3,"color":"Default"},"4":{"x":561.6000061035156,"y":64.26666259765625,"label":4,"color":"Default"},"5":{"x":600.6000061035156,"y":377.26666259765625,"label":5,"color":"Default"},"6":{"x":747.6000061035156,"y":198.26666259765625,"label":6,"color":"Default"}},"selectedEdges":[{"start":"0","end":"2","weight":"1"},{"start":"2","end":"3","weight":"2"},{"start":"3","end":"4","weight":"4"},{"start":"6","end":"5","weight":"8"}],"selectedNodes":[]}	2024-02-09 01:37:03.099+06	2024-02-09 01:37:03.099+06
2	12	2	Accepted	{"edges":[{"start":"0","end":"1","weight":"4"},{"start":"0","end":"2","weight":"1"},{"start":"2","end":"3","weight":"2"},{"start":"3","end":"4","weight":"4"},{"start":"4","end":"6","weight":"2"},{"start":"3","end":"1","weight":"3"},{"start":"1","end":"4","weight":"4"},{"start":"6","end":"5","weight":"8"},{"start":"2","end":"5","weight":"6"}],"nodes":{"0":{"x":125.60000610351562,"y":202.26666259765625,"label":0,"color":"Default"},"1":{"x":298.6000061035156,"y":71.26666259765625,"label":1,"color":"Default"},"2":{"x":271.6000061035156,"y":376.26666259765625,"label":2,"color":"Default"},"3":{"x":435.6000061035156,"y":236.26666259765625,"label":3,"color":"Default"},"4":{"x":561.6000061035156,"y":64.26666259765625,"label":4,"color":"Default"},"5":{"x":600.6000061035156,"y":377.26666259765625,"label":5,"color":"Default"},"6":{"x":747.6000061035156,"y":198.26666259765625,"label":6,"color":"Default"}},"selectedEdges":[{"start":"0","end":"2","weight":"1"},{"start":"2","end":"3","weight":"2"},{"start":"3","end":"4","weight":"4"},{"start":"4","end":"6","weight":"2"}],"selectedNodes":[]}	2024-02-09 01:38:31.41+06	2024-02-09 01:38:31.41+06
\.
...
1	Graph	Nodes and Edges	https://cdn4.iconfinder.com/data/icons/university-32/500/yul651_20_atom_molecule_business_logo_texture_technology_chemistry-512.png	t	0	2024-02-09 01:37:07.445+06	2024-02-09 01:37:07.445+06
2	Recursion	\N	https://www.svgrepo.com/show/439287/recursion.svg	t	0	2024-02-09 01:37:07.445+06	2024-02-09 01:37:07.445+06
3	Sorting	\N	https://cdn1.iconfinder.com/data/icons/flat-web-browser/100/sort-512.png	t	0	2024-02-09 01:37:07.445+06	2024-02-09 01:37:07.445+06
4	Tree	\N	https://encrypted-tbn3.gstatic.com/images?q=tbn:ANd9GcS7-pjys5IOotbaoxbBlxDklbg6YEPMwLcS0GOlOgRtEBWP_bQU	t	0	2024-02-09 01:37:07.445+06	2024-02-09 01:37:07.445+06
\.
...
1	Mahir Labib Dihan	mahirlabibdihan	/images/dihan.jpg	2024-02-09 01:37:02.652+06	2024-02-09 01:37:02.652+06
2	Mahir Labib Dihan	dihan	/images/dihan.jpg	2024-02-09 01:37:02.652+06	2024-02-09 01:37:02.652+06
3	Sayem Shahad Soummo	sayemshahadsoummo	/images/sayem.jpg	2024-02-09 01:37:02.652+06	2024-02-09 01:37:02.652+06
4	Sayem Shahad Soummo	sayem	/images/sayem.jpg	2024-02-09 01:37:02.652+06	2024-02-09 01:37:02.652+06
5	Souvik Ghosh	sheldor7701	/images/souvik.jpg	2024-02-09 01:37:02.652+06	2024-02-09 01:37:02.652+06
6	Souvik Ghosh	souvik	/images/souvik.jpg	2024-02-09 01:37:02.652+06	2024-02-09 01:37:02.652+06
7	\N	admin	\N	2024-02-09 01:37:02.652+06	2024-02-09 01:37:02.652+06
8	Roqunuzzaman Sojib	roqun	https://pics.craiyon.com/2023-09-13/c195261e4ae94815a26761786726d83a.webp	2024-02-09 01:37:02.652+06	2024-02-09 01:37:02.652+06
9	Ami Sakib	sakib	https://cdn.prod.www.spiegel.de/images/d2caafb1-70da-47e2-ba48-efd66565cde1_w1024_r0.9975262832405689_fpx44.98_fpy48.86.jpg	2024-02-09 01:37:02.652+06	2024-02-09 01:37:02.652+06
\.
...
SELECT pg_catalog.setval('public."DailyActivities_id_seq"', 2, true);
...
SELECT pg_catalog.setval('public."Problems_id_seq"', 18, true);
...
--
-- Name: DailyActivities DailyActivities_userId_problemId_activityDate_key; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public."DailyActivities"
    ADD CONSTRAINT "DailyActivities_userId_problemId_activityDate_key" UNIQUE ("userId", "problemId", "activityDate");
...
--
-- Name: Articles Articles_seriesId_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public."Articles"
    ADD CONSTRAINT "Articles_seriesId_fkey" FOREIGN KEY ("seriesId") REFERENCES public."Series"(id) ON UPDATE CASCADE ON DELETE SET NULL;
...
--
-- Name: DailyActivities DailyActivities_problemId_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public."DailyActivities"
    ADD CONSTRAINT "DailyActivities_problemId_fkey" FOREIGN KEY ("problemId") REFERENCES public."ProblemVersions"(id) ON UPDATE CASCADE ON DELETE CASCADE;
