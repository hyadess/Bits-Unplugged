...
router.get("/stat/recentfails/me", userActivityController.mostRecentFails);
router.get(
  "/stat/:username/recentfails/user",
  userActivityController.mostRecentFailsByUser
);
router.get(
...
router.get(
  ...
  userActivityController.acceptanceByProblem
);
router.get(
