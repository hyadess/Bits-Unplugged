...
83	1	1	lets see		{"nodes":[{"x":524.2833251953125,"y":148.64999389648438,"nodeIndex":0},{"x":603.2833251953125,"y":256.6499938964844,"nodeIndex":1},{"x":182.2833251953125,"y":433.6499938964844,"nodeIndex":2},{"x":831.2833251953125,"y":241.64999389648438,"nodeIndex":3}],"edges":[{"start":{"x":603.2833251953125,"y":256.6499938964844,"nodeIndex":1},"end":{"x":524.2833251953125,"y":148.64999389648438,"nodeIndex":0},"weight":"78"},{"start":{"x":182.2833251953125,"y":433.6499938964844,"nodeIndex":2},"end":{"x":524.2833251953125,"y":148.64999389648438,"nodeIndex":0},"weight":"56"},{"start":{"x":831.2833251953125,"y":241.64999389648438,"nodeIndex":3},"end":{"x":603.2833251953125,"y":256.6499938964844,"nodeIndex":1},"weight":"78"}]}	f	1703175197182	/**\n *\n * @param {Object} data - An object containing nodes and edges properties.\n * @param {Array} data.nodes - Array of nodes. Where each node is an object with x,y properties.\n * @param {Array} data.edges - Array of edges. Where each edge is an object with start, end properties.\n * @returns {boolean} True if the solution is valid, otherwise false.\n */\nfunction solutionChecker(data) {\n  const edges =  data.edges.map(edge => ({\n\t\tstart: edge.start.nodeIndex,\n\t\tend: edge.end.nodeIndex,\n\t\tweight: edge.weight\n\t}));\n\t\n  return false;\n}	\N	\N	\N
80	2	1	de		\N	f	1702822200542	/**\n *\n * @param {Object} data - An object containing pegs and disks.\n * @param {Array} data.pegs - Array of list of disks.\n * @returns {boolean} True if the solution is valid, otherwise false.\n */\nfunction solutionChecker(data) {\n  return false;\n}\n	\N	\N	\N
81	1	1	ok		\N	f	1703093836666	/**\n *\n * @param {Object} data - An object containing nodes and edges properties.\n * @param {Array} data.nodes - Array of nodes. Where each node is an object with x,y properties.\n * @param {Array} data.edges - Array of edges. Where each edge is an object with start, end properties.\n * @returns {boolean} True if the solution is valid, otherwise false.\n */\nfunction solutionChecker(data) {\n  const edges =  data.edges.map(edge => ({\n\t\tstart: edge.start.nodeIndex,\n\t\tend: edge.end.nodeIndex,\n\t\tweight: edge.weight\n\t}));\n\t\n  return false;\n}	\N	\N	\N
82	1	1	new		\N	f	1703145758897	/**\n *\n * @param {Object} data - An object containing nodes and edges properties.\n * @param {Array} data.nodes - Array of nodes. Where each node is an object with x,y properties.\n * @param {Array} data.edges - Array of edges. Where each edge is an object with start, end properties.\n * @returns {boolean} True if the solution is valid, otherwise false.\n */\nfunction solutionChecker(data) {\n  const edges =  data.edges.map(edge => ({\n\t\tstart: edge.start.nodeIndex,\n\t\tend: edge.end.nodeIndex,\n\t\tweight: edge.weight\n\t}));\n\t\n  return false;\n}	\N	\N	\N
...
SELECT pg_catalog.setval('public.problem_problem_id_seq', 84, true);
