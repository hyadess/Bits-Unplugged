...
1	30	0	t	1704019060950
1	71	0	t	1704033741412
16	69	1	t	1704034575667
1	70	0	t	1704035500698
16	70	0	t	1704035841624
16	30	0	t	1704036437744
1	98	0	t	1704107808391
16	98	0	t	1704108766650
\.
...
98	8	1	Shorter Path	Keep only the edges that forms the shortest path from 0 to 6.	{"edges":[{"start":{"x":126,"y":190.1999969482422,"nodeIndex":0},"end":{"x":287,"y":343.1999969482422,"nodeIndex":2},"weight":"1"},{"start":{"x":287,"y":343.1999969482422,"nodeIndex":2},"end":{"x":423,"y":193.1999969482422,"nodeIndex":3},"weight":"2"},{"start":{"x":423,"y":193.1999969482422,"nodeIndex":3},"end":{"x":281,"y":61.19999694824219,"nodeIndex":1},"weight":"3"},{"start":{"x":281,"y":61.19999694824219,"nodeIndex":1},"end":{"x":126,"y":190.1999969482422,"nodeIndex":0},"weight":"4"},{"start":{"x":423,"y":193.1999969482422,"nodeIndex":3},"end":{"x":556,"y":64.19999694824219,"nodeIndex":4},"weight":"4"},{"start":{"x":281,"y":61.19999694824219,"nodeIndex":1},"end":{"x":556,"y":64.19999694824219,"nodeIndex":4},"weight":"4"},{"start":{"x":556,"y":64.19999694824219,"nodeIndex":4},"end":{"x":722,"y":185.1999969482422,"nodeIndex":6},"weight":"2"},{"start":{"x":722,"y":185.1999969482422,"nodeIndex":6},"end":{"x":586,"y":342.1999969482422,"nodeIndex":5},"weight":"8"},{"start":{"x":586,"y":342.1999969482422,"nodeIndex":5},"end":{"x":287,"y":343.1999969482422,"nodeIndex":2},"weight":"6"}],"nodes":[{"x":126,"y":190.1999969482422,"nodeIndex":0},{"x":281,"y":61.19999694824219,"nodeIndex":1},{"x":287,"y":343.1999969482422,"nodeIndex":2},{"x":423,"y":193.1999969482422,"nodeIndex":3},{"x":556,"y":64.19999694824219,"nodeIndex":4},{"x":586,"y":342.1999969482422,"nodeIndex":5},{"x":722,"y":185.1999969482422,"nodeIndex":6}]}	t	1704106904024	/**\n *\n * @param {Object} data - An object containing nodes and edges properties.\n * @param {Array} data.nodes - Array of nodes. Where each node is an object with x,y properties.\n * @param {Array} data.edges - Array of edges. Where each edge is an object with start, end properties.\n * @returns {boolean} True if the solution is valid, otherwise false.\n */\nfunction solutionChecker(data) {\n  const edges =  data.edges.map(edge => ({\n\t\tstart: edge.start.nodeIndex,\n\t\tend: edge.end.nodeIndex,\n\t\tweight: edge.weight\n\t}));\n\t\n  return false;\n}	{"variant":{"value":"simple_graph","type":"select","list":["simple_graph","tree"]},"directed_edge":{"value":false,"type":"switch"},"weighted_edge":{"value":true,"type":"switch"}}	{}	{"add_node":{"value":false,"type":"switch"},"delete_node":{"value":false,"type":"switch"},"drag_node":{"value":false,"type":"switch"},"add_edge":{"value":false,"type":"switch"},"delete_edge":{"value":true,"type":"switch"}}	1	9	1	1	{"edges":[{"start":{"x":126,"y":190.1999969482422,"nodeIndex":0},"end":{"x":287,"y":343.1999969482422,"nodeIndex":2},"weight":"1"},{"start":{"x":287,"y":343.1999969482422,"nodeIndex":2},"end":{"x":423,"y":193.1999969482422,"nodeIndex":3},"weight":"2"},{"start":{"x":423,"y":193.1999969482422,"nodeIndex":3},"end":{"x":556,"y":64.19999694824219,"nodeIndex":4},"weight":"4"},{"start":{"x":556,"y":64.19999694824219,"nodeIndex":4},"end":{"x":722,"y":185.1999969482422,"nodeIndex":6},"weight":"2"}],"nodes":[{"x":126,"y":190.1999969482422,"nodeIndex":0},{"x":281,"y":61.19999694824219,"nodeIndex":1},{"x":287,"y":343.1999969482422,"nodeIndex":2},{"x":423,"y":193.1999969482422,"nodeIndex":3},{"x":556,"y":64.19999694824219,"nodeIndex":4},{"x":586,"y":342.1999969482422,"nodeIndex":5},{"x":722,"y":185.1999969482422,"nodeIndex":6}]}
30	1	1	Road Construction	There are 5 cities numbered from 0 to 4. We can construct roads between cities. Each road has a number associated with it denoting the cost to construct a road. We want to minimize our cost. **Remove the roads from the given canvas in a way that from every city we can go to every other city and cost of constructing the remaining roads are minimum.**	{"nodes":[{"x":191.46353373570471,"y":209.08105010004624,"nodeIndex":0},{"x":480.45356288618734,"y":79.05215958998558,"nodeIndex":1},{"x":717.4589382793936,"y":266.96633313305256,"nodeIndex":2},{"x":440.46237224675286,"y":238.0461718019531,"nodeIndex":3},{"x":415.4808662930142,"y":394.99793083470826,"nodeIndex":4}],"edges":[{"start":{"x":191.46353373570471,"y":209.08105010004624,"nodeIndex":0},"end":{"x":480.45356288618734,"y":79.05215958998558,"nodeIndex":1},"weight":"10"},{"start":{"x":480.45356288618734,"y":79.05215958998558,"nodeIndex":1},"end":{"x":717.4589382793936,"y":266.96633313305256,"nodeIndex":2},"weight":"30"},{"start":{"x":480.45356288618734,"y":79.05215958998558,"nodeIndex":1},"end":{"x":440.46237224675286,"y":238.0461718019531,"nodeIndex":3},"weight":"5"},{"start":{"x":191.46353373570471,"y":209.08105010004624,"nodeIndex":0},"end":{"x":415.4808662930142,"y":394.99793083470826,"nodeIndex":4},"weight":"2"},{"start":{"x":415.4808662930142,"y":394.99793083470826,"nodeIndex":4},"end":{"x":717.4589382793936,"y":266.96633313305256,"nodeIndex":2},"weight":"50"},{"start":{"x":415.4808662930142,"y":394.99793083470826,"nodeIndex":4},"end":{"x":440.46237224675286,"y":238.0461718019531,"nodeIndex":3},"weight":"3"}]}	t	1694032352472	/**\n * @param {Object} data - An object containing nodes and edges properties.\n * @param {Array} data.nodes - Array of nodes. Where each node is an object with x,y properties.\n * @param {Array} data.edges - Array of edges. Where each edge is an object with start, end properties.\n * @returns {boolean} True if the solution is valid, otherwise false.\n */\nfunction solutionChecker(data) {\n  const graph = new Map();\n  for (const edge of data.edges) {\n  const { start, end, weight } = edge;\n  \n  if (!graph.has(start.nodeIndex)) {\n    graph.set(start.nodeIndex, []);\n  }\n  \n  if (!graph.has(end.nodeIndex)) {\n    graph.set(end.nodeIndex, []);\n  }\n  \n  graph.get(start.nodeIndex).push({ nodeIndex: end.nodeIndex, weight: parseInt(weight) });\n  graph.get(end.nodeIndex).push({ nodeIndex: start.nodeIndex, weight: parseInt(weight) });\n}\n\n// Step 3: Implement DFS to check if the graph is disconnected\nfunction isDisconnected() {\n  const visited = new Set();\n  const nodes = [...graph.keys()];\n  \n  function dfs(node) {\n    visited.add(node);\n    for (const neighbor of graph.get(node)) {\n      if (!visited.has(neighbor.nodeIndex)) {\n        dfs(neighbor.nodeIndex);\n      }\n    }\n  }\n  \n  dfs(nodes[0]); // Start DFS from the first node\n  \n  return visited.size !== nodes.length;\n}\n\nconst disconnected = isDisconnected();\n\n// Step 4: Calculate the sum of edge weights\nfunction sumEdgeWeights() {\n  let sum = 0;\n  for (const edges of graph.values()) {\n    for (const edge of edges) {\n      sum += edge.weight;\n    }\n  }\n  return sum/2;\n}\n\n\n\n\t// if (disconnected)\n\t// \treturn false;\n\n\t// else {\n  const edgeWeightSum = sumEdgeWeights();\n  console.log(edgeWeightSum);\n\t\tif(edgeWeightSum == 40){\n\t\t\treturn true;\t\n\t\t}\n\t\telse {\n\t\t\treturn false;\n\t\t}\n\t// }\n\n}\n\n\n/* Test */	{"variant":{"value":"simple_graph","type":"select","list":["simple_graph","tree"]},"directed_edge":{"value":false,"type":"switch"},"weighted_edge":{"value":true,"type":"switch"}}	{}	{"add_node":{"value":false,"type":"switch"},"delete_node":{"value":false,"type":"switch"},"drag_node":{"value":false,"type":"switch"},"add_edge":{"value":false,"type":"switch"},"delete_edge":{"value":true,"type":"switch"}}	1	3	1	1	{"nodes":[{"x":191.46353373570471,"y":209.08105010004624,"nodeIndex":0},{"x":480.45356288618734,"y":79.05215958998558,"nodeIndex":1},{"x":717.4589382793936,"y":266.96633313305256,"nodeIndex":2},{"x":440.46237224675286,"y":238.0461718019531,"nodeIndex":3},{"x":415.4808662930142,"y":394.99793083470826,"nodeIndex":4}],"edges":[{"start":{"x":480.45356288618734,"y":79.05215958998558,"nodeIndex":1},"end":{"x":717.4589382793936,"y":266.96633313305256,"nodeIndex":2},"weight":"30"},{"start":{"x":480.45356288618734,"y":79.05215958998558,"nodeIndex":1},"end":{"x":440.46237224675286,"y":238.0461718019531,"nodeIndex":3},"weight":"5"},{"start":{"x":191.46353373570471,"y":209.08105010004624,"nodeIndex":0},"end":{"x":415.4808662930142,"y":394.99793083470826,"nodeIndex":4},"weight":"2"},{"start":{"x":415.4808662930142,"y":394.99793083470826,"nodeIndex":4},"end":{"x":440.46237224675286,"y":238.0461718019531,"nodeIndex":3},"weight":"3"}]}
99	9	1	Bipartition	Remove minimum possible edges, such that the graph is a bipartite graph.	{"edges":[{"start":{"x":630,"y":161.8000030517578,"nodeIndex":6},"end":{"x":552,"y":94.80000305175781,"nodeIndex":5},"weight":"0"},{"start":{"x":195,"y":260.8000030517578,"nodeIndex":4},"end":{"x":642,"y":289.8000030517578,"nodeIndex":7},"weight":"0"},{"start":{"x":240,"y":131.8000030517578,"nodeIndex":2},"end":{"x":552,"y":94.80000305175781,"nodeIndex":5},"weight":"0"},{"start":{"x":195,"y":260.8000030517578,"nodeIndex":4},"end":{"x":565,"y":402.8000030517578,"nodeIndex":3},"weight":"0"},{"start":{"x":331,"y":417.8000030517578,"nodeIndex":1},"end":{"x":240,"y":131.8000030517578,"nodeIndex":2},"weight":"0"},{"start":{"x":369,"y":49.80000305175781,"nodeIndex":0},"end":{"x":642,"y":289.8000030517578,"nodeIndex":7},"weight":"0"},{"start":{"x":240,"y":131.8000030517578,"nodeIndex":2},"end":{"x":565,"y":402.8000030517578,"nodeIndex":3},"weight":"0"},{"start":{"x":552,"y":94.80000305175781,"nodeIndex":5},"end":{"x":369,"y":49.80000305175781,"nodeIndex":0},"weight":"0"},{"start":{"x":331,"y":417.8000030517578,"nodeIndex":1},"end":{"x":195,"y":260.8000030517578,"nodeIndex":4},"weight":"0"},{"start":{"x":331,"y":417.8000030517578,"nodeIndex":1},"end":{"x":565,"y":402.8000030517578,"nodeIndex":3},"weight":"0"},{"start":{"x":195,"y":260.8000030517578,"nodeIndex":4},"end":{"x":630,"y":161.8000030517578,"nodeIndex":6},"weight":"0"}],"nodes":[{"x":369,"y":49.80000305175781,"nodeIndex":0},{"x":331,"y":417.8000030517578,"nodeIndex":1},{"x":240,"y":131.8000030517578,"nodeIndex":2},{"x":565,"y":402.8000030517578,"nodeIndex":3},{"x":195,"y":260.8000030517578,"nodeIndex":4},{"x":552,"y":94.80000305175781,"nodeIndex":5},{"x":630,"y":161.8000030517578,"nodeIndex":6},{"x":642,"y":289.8000030517578,"nodeIndex":7}]}	t	1704109169798	/**\n *\n * @param {Object} data - An object containing nodes and edges properties.\n * @param {Array} data.nodes - Array of nodes. Where each node is an object with x,y properties.\n * @param {Array} data.edges - Array of edges. Where each edge is an object with start, end properties.\n * @returns {boolean} True if the solution is valid, otherwise false.\n */\nfunction solutionChecker(data) {\n  const edges =  data.edges.map(edge => ({\n\t\tstart: edge.start.nodeIndex,\n\t\tend: edge.end.nodeIndex,\n\t\tweight: edge.weight\n\t}));\n\t\n  return false;\n}	{"variant":{"value":"simple_graph","type":"select","list":["simple_graph","tree"]},"directed_edge":{"value":false,"type":"switch"},"weighted_edge":{"value":false,"type":"switch"}}	{}	{"add_node":{"value":false,"type":"switch"},"delete_node":{"value":false,"type":"switch"},"drag_node":{"value":false,"type":"switch"},"add_edge":{"value":false,"type":"switch"},"delete_edge":{"value":true,"type":"switch"}}	1	10	0	1	{"edges":[{"start":{"x":630,"y":161.8000030517578,"nodeIndex":6},"end":{"x":552,"y":94.80000305175781,"nodeIndex":5},"weight":"0"},{"start":{"x":195,"y":260.8000030517578,"nodeIndex":4},"end":{"x":642,
eIndex":4},"end":{"x":440.46237224675286,"y":238.0461718019531,"nodeIndex":3},"weight":"3"}]}	/**\n * @param {Object} data - An object containing nodes and edges properties.\n * @param {Array} data.nodes - Array of nodes. Where each node is an object with x,y properties.\n * @param {Array} data.edges - Array of edges. Where each edge is an object with start, end properties.\n * @returns {boolean} True if the solution is valid, otherwise false.\n */\nfunction solutionChecker(data) {\n  const graph = new Map();\n  for (const edge of data.edges) {\n  const { start, end, weight } = edge;\n  \n  if (!graph.has(start.nodeIndex)) {\n    graph.set(start.nodeIndex, []);\n  }\n  \n  if (!graph.has(end.nodeIndex)) {\n    graph.set(end.nodeIndex, []);\n  }\n  \n  graph.get(start.nodeIndex).push({ nodeIndex: end.nodeIndex, weight: parseInt(weight) });\n  graph.get(end.nodeIndex).push({ nodeIndex: start.nodeIndex, weight: parseInt(weight) });\n}\n\n// Step 3: Implement DFS to check if the graph is disconnected\nfunction isDisconnected() {\n  const visited = new Set();\n  const nodes = [...graph.keys()];\n  \n  function dfs(node) {\n    visited.add(node);\n    for (const neighbor of graph.get(node)) {\n      if (!visited.has(neighbor.nodeIndex)) {\n        dfs(neighbor.nodeIndex);\n      }\n    }\n  }\n  \n  dfs(nodes[0]); // Start DFS from the first node\n  \n  return visited.size !== nodes.length;\n}\n\nconst disconnected = isDisconnected();\n\n// Step 4: Calculate the sum of edge weights\nfunction sumEdgeWeights() {\n  let sum = 0;\n  for (const edges of graph.values()) {\n    for (const edge of edges) {\n      sum += edge.weight;\n    }\n  }\n  return sum/2;\n}\n\n\n\n\t// if (disconnected)\n\t// \treturn false;\n\n\t// else {\n  const edgeWeightSum = sumEdgeWeights();\n  console.log(edgeWeightSum);\n\t\tif(edgeWeightSum == 40){\n\t\t\treturn true;\t\n\t\t}\n\t\telse {\n\t\t\treturn false;\n\t\t}\n\t// }\n\n}\n\n\n/* Test */	{"variant":{"value":"simple_graph","type":"select","list":["simple_graph","tree"]},"directed_edge":{"value":false,"type":"switch"},"weighted_edge":{"value":true,"type":"switch"}}	{}	{"add_node":{"value":false,"type":"switch"},"delete_node":{"value":false,"type":"switch"},"drag_node":{"value":false,"type":"switch"},"add_edge":{"value":false,"type":"switch"},"delete_edge":{"value":true,"type":"switch"}}	1704036372865	1	1	{"nodes":[{"x":191.46353373570471,"y":209.08105010004624,"nodeIndex":0},{"x":480.45356288618734,"y":79.05215958998558,"nodeIndex":1},{"x":717.4589382793936,"y":266.96633313305256,"nodeIndex":2},{"x":440.46237224675286,"y":238.0461718019531,"nodeIndex":3},{"x":415.4808662930142,"y":394.99793083470826,"nodeIndex":4}],"edges":[{"start":{"x":480.45356288618734,"y":79.05215958998558,"nodeIndex":1},"end":{"x":717.4589382793936,"y":266.96633313305256,"nodeIndex":2},"weight":"30"},{"start":{"x":480.45356288618734,"y":79.05215958998558,"nodeIndex":1},"end":{"x":440.46237224675286,"y":238.0461718019531,"nodeIndex":3},"weight":"5"},{"start":{"x":191.46353373570471,"y":209.08105010004624,"nodeIndex":0},"end":{"x":415.4808662930142,"y":394.99793083470826,"nodeIndex":4},"weight":"2"},{"start":{"x":415.4808662930142,"y":394.99793083470826,"nodeIndex":4},"end":{"x":440.46237224675286,"y":238.0461718019531,"nodeIndex":3},"weight":"3"}]}
9	Shorter Path	Keep only the edges that forms the shortest path from 0 to 6.	{"edges":[{"start":{"x":126,"y":190.1999969482422,"nodeIndex":0},"end":{"x":287,"y":343.1999969482422,"nodeIndex":2},"weight":"1"},{"start":{"x":287,"y":343.1999969482422,"nodeIndex":2},"end":{"x":423,"y":193.1999969482422,"nodeIndex":3},"weight":"2"},{"start":{"x":423,"y":193.1999969482422,"nodeIndex":3},"end":{"x":281,"y":61.19999694824219,"nodeIndex":1},"weight":"3"},{"start":{"x":281,"y":61.19999694824219,"nodeIndex":1},"end":{"x":126,"y":190.1999969482422,"nodeIndex":0},"weight":"4"},{"start":{"x":423,"y":193.1999969482422,"nodeIndex":3},"end":{"x":556,"y":64.19999694824219,"nodeIndex":4},"weight":"4"},{"start":{"x":281,"y":61.19999694824219,"nodeIndex":1},"end":{"x":556,"y":64.19999694824219,"nodeIndex":4},"weight":"4"},{"start":{"x":556,"y":64.19999694824219,"nodeIndex":4},"end":{"x":722,"y":185.1999969482422,"nodeIndex":6},"weight":"2"},{"start":{"x":722,"y":185.1999969482422,"nodeIndex":6},"end":{"x":586,"y":342.1999969482422,"nodeIndex":5},"weight":"8"},{"start":{"x":586,"y":342.1999969482422,"nodeIndex":5},"end":{"x":287,"y":343.1999969482422,"nodeIndex":2},"weight":"6"}],"nodes":[{"x":126,"y":190.1999969482422,"nodeIndex":0},{"x":281,"y":61.19999694824219,"nodeIndex":1},{"x":287,"y":343.1999969482422,"nodeIndex":2},{"x":423,"y":193.1999969482422,"nodeIndex":3},{"x":556,"y":64.19999694824219,"nodeIndex":4},{"x":586,"y":342.1999969482422,"nodeIndex":5},{"x":722,"y":185.1999969482422,"nodeIndex":6}]}	/**\n *\n * @param {Object} data - An object containing nodes and edges properties.\n * @param {Array} data.nodes - Array of nodes. Where each node is an object with x,y properties.\n * @param {Array} data.edges - Array of edges. Where each edge is an object with start, end properties.\n * @returns {boolean} True if the solution is valid, otherwise false.\n */\nfunction solutionChecker(data) {\n  const edges =  data.edges.map(edge => ({\n\t\tstart: edge.start.nodeIndex,\n\t\tend: edge.end.nodeIndex,\n\t\tweight: edge.weight\n\t}));\n\t\n  return false;\n}	{"variant":{"value":"simple_graph","type":"select","list":["simple_graph","tree"]},"directed_edge":{"value":false,"type":"switch"},"weighted_edge":{"value":true,"type":"switch"}}	{}	{"add_node":{"value":false,"type":"switch"},"delete_node":{"value":false,"type":"switch"},"drag_node":{"value":false,"type":"switch"},"add_edge":{"value":false,"type":"switch"},"delete_edge":{"value":true,"type":"switch"}}	1704108621290	
,"nodeIndex":6},{"x":642,"y":289.8000030517578,"nodeIndex":7}]}	/**\n *\n * @param {Object} data - An object containing nodes and edges properties.\n * @param {Array} data.nodes - Array of nodes. Where each node is an object with x,y properties.\n * @param {Array} data.edges - Array of edges. Where each edge is an object with start, end properties.\n * @returns {boolean} True if the solution is valid, otherwise false.\n */\nfunction solutionChecker(data) {\n  const edges =  data.edges.map(edge => ({\n\t\tstart: edge.start.nodeIndex,\n\t\tend: edge.end.nodeIndex,\n\t\tweight: edge.weight\n\t}));\n\t\n  return false;\n}	{"variant":{"value":"simple_graph","type":"select","list":["simple_graph","tree"]},"directed_edge":{"value":false,"type":"switch"},"weighted_edge":{"value":false,"type":"switch"}}	{}	{"add_node":{"value":false,"type":"switch"},"delete_node":{"value":false,"type":"switch"},"drag_node":{"value":false,"type":"switch"},"add_edge":{"value":false,"type":"switch"},"delete_edge":{"value":true,"type":"switch"}}	1704109531725	1	1	{"edges":[{"start":{"x":630,"y":161.8000030517578,"nodeIndex":6},"end":{"x":552,"y":94.80000305175781,"nodeIndex":5},"weight":"0"},{"start":{"x":195,"y":260.8000030517578,"nodeIndex":4},"end":{"x":642,"y":289.8000030517578,"nodeIndex":7},"weight":"0"},{"start":{"x":240,"y":131.8000030517578,"nodeIndex":2},"end":{"x":552,"y":94.80000305175781,"nodeIndex":5},"weight":"0"},{"start":{"x":195,"y":260.8000030517578,"nodeIndex":4},"end":{"x":565,"y":402.8000030517578,"nodeIndex":3},"weight":"0"},{"start":{"x":331,"y":417.8000030517578,"nodeIndex":1},"end":{"x":240,"y":131.8000030517578,"nodeIndex":2},"weight":"0"},{"start":{"x":369,"y":49.80000305175781,"nodeIndex":0},"end":{"x":642,"y":289.8000030517578,"nodeIndex":7},"weight":"0"},{"start":{"x":240,"y":131.8000030517578,"nodeIndex":2},"end":{"x":565,"y":402.8000030517578,"nodeIndex":3},"weight":"0"},{"start":{"x":552,"y":94.80000305175781,"nodeIndex":5},"end":{"x":369,"y":49.80000305175781,"nodeIndex":0},"weight":"0"},{"start":{"x":331,"y":417.8000030517578,"nodeIndex":1},"end":{"x":195,"y":260.8000030517578,"nodeIndex":4},"weight":"0"}],"nodes":[{"x":369,"y":49.80000305175781,"nodeIndex":0},{"x":331,"y":417.8000030517578,"nodeIndex":1},{"x":240,"y":131.8000030517578,"nodeIndex":2},{"x":565,"y":402.8000030517578,"nodeIndex":3},{"x":195,"y":260.8000030517578,"nodeIndex":4},{"x":552,"y":94.80000305175781,"nodeIndex":5},{"x":630,"y":161.8000030517578,"nodeIndex":6},{"x":642,"y":289.8000030517578,"nodeIndex":7}]}
\.
...
SELECT pg_catalog.setval('public.problem_problem_id_seq', 99, true);
...
SELECT pg_catalog.setval('public.series_series_id_seq', 9, true);
...
SELECT pg_catalog.setval('public.state_state_id_seq', 10, true);
...
SELECT pg_catalog.setval('public.submissions_submission_id_seq', 29, true);
