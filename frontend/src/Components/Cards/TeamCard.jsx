  ...
  return (
    ...
    >
      ...
      <div class="p-5 h-full w-full flex flex-col items-center justify-between">
        <h3 class="text-l md:text-xl text-center font-bold tracking-tight text-gray-900 text-white">
          <a href="#">{name}</a>
        </h3>
        <div className="flex flex-col items-center">
          <span class="text-sm md:text-base text-gray-500 text">
            {position}
          </span>

          <p class="mt-3 mb-4 font-light text-gray-500 text-sm md:text-base">
            {detail}
          </p>
