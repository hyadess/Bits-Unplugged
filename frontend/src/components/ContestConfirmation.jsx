...
const ContestConfirmation = ({ open, setOpen, onConfirm, param }) => {
  const handleClose = () => {
    setOpen(false);
  };
  return (
    ...
    >
      <DialogTitle id="alert-dialog-title">
        Starting a new virtual contest will remove all of your submissions from previous virtual participation.
