...
const ProblemSetEnvController = () => {
  ...
  useEffect(() => {
    console.log("=>", problemContext.state);
  }, [problemContext.state]);
  ...
  useEffect(() => {
    console.log("===========>", problem.checkerCode);
  }, [problem.checkerCode]);
  ...
  const handleCheckSolution = async () =>
    ...
    // userActivity
    {
      console.log("Run COde", problem.checkerCode);
      try {
...
export default ProblemSetEnvController;
